...
//public class TrueValue : BoolValue { }
//public class FalseValue : BoolValue { }

public class SerializableDictionary { }

/// <summary>
/// 序列化字典，最后的F或T表示key和value是否子类序列化
/// </summary>
/// <typeparam name="TKey"></typeparam>
/// <typeparam name="TValue"></typeparam>
[Serializable]
public class SerializableDictionaryFF<TKey, TValue> :
    ...
    IDictionary<TKey, TValue>
{
    ...
    public SerializableDictionaryFF()
    {
        _keyPositions = new Lazy<Dictionary<TKey, int>>(MakeKeyPositions);
        ////特性
        //if (typeof(KeyIsSubclassSelector) == typeof(TrueValue))
        //{
        //    var fieldInfo = typeof(SerializableKeyValuePair).GetField("Key");
        //    TypeDescriptor.AddAttributes(fieldInfo, new Attribute[] { new SerializeReference(), new SubclassSelectorAttribute() });
        //}
        //if (typeof(ValueIsSubclassSelector) == typeof(TrueValue))
        //{
        //    var fieldInfo = typeof(SerializableKeyValuePair).GetField("Value");
        //    TypeDescriptor.AddAttributes(fieldInfo, new Attribute[] { new SerializeReference(), new SubclassSelectorAttribute() });
        //}
    }
...
/// <typeparam name="TValue"></typeparam>
[Serializable]
public class SerializableDictionaryFT<TKey, TValue> :
    SerializableDictionary,
    ISerializationCallbackReceiver,
    IDictionary<TKey, TValue>
{
    ...
    public SerializableDictionaryFT()
    {
        _keyPositions = new Lazy<Dictionary<TKey, int>>(MakeKeyPositions);
        ////特性
        //if (typeof(KeyIsSubclassSelector) == typeof(TrueValue))
...
/// <typeparam name="TValue"></typeparam>
[Serializable]
public class SerializableDictionaryTF<TKey, TValue> :
    SerializableDictionary,
    ISerializationCallbackReceiver,
    IDictionary<TKey, TValue>
{
    ...
    public SerializableDictionaryTF()
    {
        _keyPositions = new Lazy<Dictionary<TKey, int>>(MakeKeyPositions);
        ////特性
        //if (typeof(KeyIsSubclassSelector) == typeof(TrueValue))
...
/// <typeparam name="TValue"></typeparam>
[Serializable]
public class SerializableDictionaryTT<TKey, TValue> :
    SerializableDictionary,
    ISerializationCallbackReceiver,
    IDictionary<TKey, TValue>
{
    ...
    public SerializableDictionaryTT()
    {
        _keyPositions = new Lazy<Dictionary<TKey, int>>(MakeKeyPositions);
        ////特性
        //if (typeof(KeyIsSubclassSelector) == typeof(TrueValue))
